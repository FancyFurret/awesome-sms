 ...
 * be sorted on each of the specified columns in descending order. This joiner only
 * supports the case where the tuple of key column values is unique. Only supports
 ...
 * </pre>
 */
public class DescIntCursorJoiner
        implements Iterator<DescIntCursorJoiner.Result>, Iterable<DescIntCursorJoiner.Result> {
    ...
    public DescIntCursorJoiner(
        ...
        mValues = new Integer[mColumnsLeft.length * 2];
    }
    ...
    /**
     * Reads the integers from the cursor that are specifed in the columnIndicies
     ...
     */
    private static int compareValues(Integer... values) {
